    ...
    return (
        ...
        <div className="row">
          <div className="col-sm-5" id="header-bal" style={{margin: 'auto'}}>
            <img src="images/logo.webp" className="img-fluid"></img>
          </div>
          <div className="col-sm-5 d-none d-md-block" id="header-jobb" style={{margin: 'auto'}}>
            <img src="images/img-1.webp" className="img-fluid" />
          </div>
        </div>
      </div></div>
      {/* HEADER vége*/}
          {/* RÓLUNK */}
        <div style={{backgroundColor: 'rgb(236, 252, 255)',color:'rgb(236, 252, 255)'}}>HAGYD BENNE !!</div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <br />
                <NavLink to={'/about'}><a className="sotet"><b>Továbbiak</b><span style={{padding: '10px'}}><img src="images/contact-icon1.webp" /></span></a></NavLink>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{backgroundColor: 'rgb(236, 246, 255)', padding: '20px'}}>
          <div className="container">
            ...
            <div className="row">
              ...
              <NavLink to={'/why'}><a className="sotet"><b>Továbbiak</b><span style={{padding: '10px'}}><img src="images/contact-icon1.webp" /></span></a></NavLink>
            </div>
          </div>         
        </div>
        {/* MIÉRT MI vége */}
