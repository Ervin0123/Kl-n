...
namespace CleanBackend
{
    public class Program
    {
        ...
        public static void SendEmail(string mailAddressTo, string subject, string body)
        {
            ...
            mail.From = new MailAddress("kisse@kkszki.hu");
            ...
            SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("kisse@kkszki.hu", "72230419557" + "");
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    ...
                    webBuilder.UseUrls("https://localhost:6969");
                });
    }
}
